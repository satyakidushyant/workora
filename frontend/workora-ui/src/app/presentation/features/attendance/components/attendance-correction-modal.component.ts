      ...
      <div class="bg-white rounded-3xl p-6 sm:p-8 w-full max-w-md border border-[#DCEBE7] shadow-2xl space-y-6 animate-in fade-in zoom-in-95 duration-150">
        ...
        <form [formGroup]="form" (ngSubmit)="onSubmit()" class="space-y-4">
          <div class="grid grid-cols-2 gap-4">
            <div>
              <label class="block text-xs font-bold text-[#063B39] mb-1">Adjusted Check In</label>
              <input 
                type="time" 
            ...
            <div>
              <label class="block text-xs font-bold text-[#063B39] mb-1">Adjusted Check Out</label>
              <input 
                type="time" 
          ...
          <div>
            <label class="block text-xs font-bold text-[#063B39] mb-1">Reason for Missed / Incorrect Punch <span class="text-rose-500">*</span></label>
            <textarea 
