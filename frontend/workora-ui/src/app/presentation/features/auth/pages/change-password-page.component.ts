  ...
  template: `
    <div class="p-6 lg:p-8 space-y-6 max-w-7xl mx-auto w-full relative z-10">
      ...
      <div class="security-header">
        ...
        <h1 class="text-2xl sm:text-3xl font-extrabold text-[#063B39] tracking-tight font-heading">Security &amp; Password</h1>
      ...
      <!-- Bento Grid Layout -->
      <div class="grid grid-cols-12 gap-6 security-grid">
        
        <!-- Main Update Password Form (8 Columns) -->
        <div class="col-span-12 lg:col-span-8 space-y-6">
          <section class="bg-white rounded-2xl p-6 sm:p-8 border border-[#DCEBE7] shadow-sm workora-card">
            <div class="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 class="text-lg font-bold text-[#063B39] font-heading">Update Password</h2>
            ...
            <form class="space-y-4" (ngSubmit)="onSubmit()">
              ...
              <div class="space-y-1">
                ...
                <div class="relative flex items-center">
                  ...
                  />
                  <button 
                    class="material-symbols-outlined text-slate-400 hover:text-[#063B39] transition-colors cursor-pointer text-lg absolute right-3 flex items-center justify-center border-none bg-transparent" 
                    type="button"
              ...
              <!-- Form Actions -->
              <div class="pt-4 flex items-center justify-end gap-3 border-t border-[#DCEBE7]">
                <button 
                  class="px-4 py-2 text-xs font-bold text-slate-600 hover:bg-[#DCEBE7]/30 rounded-xl transition-colors border-none bg-transparent cursor-pointer" 
                  type="button"
                  (click)="onCancel()"
                >
                  Discard Changes
