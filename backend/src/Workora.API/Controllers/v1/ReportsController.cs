...
public class ReportsController : ControllerBase
{
    ...
    public async Task<ApiResponse<HeadcountReportDto>> GetHeadcountReport([FromQuery] int companyId)
    ...
    [HttpGet("attendance")]
    [Authorize(Policy = "reports.view")]
    public async Task<ApiResponse<AttendanceReportDto>> GetAttendanceReport([FromQuery] int companyId)
